/*
 * (mu+lambda)-ES_WP_RS.h
 *
 *  Created on: 04 apr 2017
 *      Author: RedShy
 */

#ifndef mu_lambda_ES_WP_RS
#define mu_lambda_ES_WP_RS
...
int evolutionStrategy_WP_RS(const std::vector<unsigned>& s1,
